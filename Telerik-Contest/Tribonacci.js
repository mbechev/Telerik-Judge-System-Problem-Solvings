...
let firstNum = bigInt(gets());
let secondNum = bigInt(gets());
let thirdNum = bigInt(gets());
let iterate = bigInt(gets());
let newNum = 0;

for (let i = 3; i < iterate; i++) {
    newNum = bigInt(firstNum).add(secondNum).add(thirdNum);
    firstNum = bigInt(secondNum);
    secondNum = bigInt(thirdNum);
    thirdNum = bigInt(newNum);
}
print(newNum)